...
//class for angles
class Simple_Gaus : public RooAbsPdf {
 public:
  Simple_Gaus() {} ;
  Simple_Gaus(const char *name, const char *title,
	      RooAbsReal& _x,
	      RooAbsReal& _mu,
	      RooAbsReal& _sigma);

  Simple_Gaus(const Simple_Gaus& other, const char* name=0) ;

  virtual TObject* clone(const char* newname) const { return new Simple_Gaus(*this,newname); }

  inline virtual ~Simple_Gaus() { }
 ...
 private:
  ...
  ClassDef(Simple_Gaus,1) // Your description goes here...
    };  
//end class for angles
